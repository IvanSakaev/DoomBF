...
Ячейки с 16ой по S+15 - стек
                        ...
                        Для вызова блока без возврата нужно просто поместить его адрес в стек.
                            Рекурсия разрешена, но ее можно использовать только в режиме работы без возврата.
...
+[>
    ...
    Блок 1      Инициализация чисел в регистрах
    -<[-]+<[-]+>>[<-<->]<[<-]>[->
        >+++++++>++++<<
    ...
    Блок 2      Перемещение числа из регистра A в 25ю ячейку
    -<[-]+<[-]+>>[<-<->]<[<-]>[->
        >[>>>>>>>>>>>>>>>>>+<<<<<<<<<<<<<<<<<-]<
    <]>
