...
#define PADSAVEP() save_p += (4 - ((bfptr_t)save_p & 3)) & 3
        ...
        for (j = 0; j < NUMPSPRITES; j++)
        {
            if (players[i].psprites[j].state)
            {
                players[i].psprites[j].state
                    = &states[(bfptr_t)players[i].psprites[j].state];
            }
        }
    }
}
    ...
    while (1)
    {
        ...
        switch (tclass)
        {
            ...
            case tc_mobj:
                ...
                save_p += sizeof(*mobj);
                mobj->state = &states[(bfptr_t)mobj->state];
                mobj->target = 0;
                if (mobj->player)
                {
                    mobj->player = &players[(bfptr_t)mobj->player - 1];
                    mobj->player->mo = mobj;
                }
    ...
    while (1)
    {
        ...
        switch (tclass)
        {
            ...
            case tc_ceiling:
                ...
                save_p += sizeof(*ceiling);
                ceiling->sector = &sectors[(bfptr_t)ceiling->sector];
            ...
            case tc_door:
                ...
                save_p += sizeof(*door);
                door->sector = &sectors[(bfptr_t)door->sector];
            ...
            case tc_floor:
                ...
                save_p += sizeof(*floor);
                floor->sector = &sectors[(bfptr_t)floor->sector];
            ...
            case tc_plat:
                ...
                save_p += sizeof(*plat);
                plat->sector = &sectors[(bfptr_t)plat->sector];
            ...
            case tc_flash:
                ...
                save_p += sizeof(*flash);
                flash->sector = &sectors[(bfptr_t)flash->sector];
            ...
            case tc_strobe:
                ...
                save_p += sizeof(*strobe);
                strobe->sector = &sectors[(bfptr_t)strobe->sector];
            ...
            case tc_glow:
                ...
                save_p += sizeof(*glow);
                glow->sector = &sectors[(bfptr_t)glow->sector];
